...
<div class="head-part homemenu">
   <div class="container">
      <header>
         <img src="<?php echo $this->url->getStatic('images/baliprorent-logo.png'); ?>" class="logo"/>
      </header>
         ...
         <div class="container">
            <div class="col-sm-12 col-md-12 col-xs-12">
               ...
               <div class="col-sm-2 col-sm-offset-0 col-md-2 col-xs-6 col-xs-offset-3">
                  ...
                  <button type="submit" class="btn btn-primary"><?php echo $t->_('search'); ?></button>
               </div>
            </div>
         </div>
      </div>
   ...
   <div class="main-second">
      <div class="container">
         ...
         <div class="col-sm-12 col-md-12 col-xs-12 vacation-logo">
            <div class="col-sm-3 col-md-3 col-xs-6">
               <img class="img-responsive" src="<?php echo $this->url->getStatic('images/vacation-logo1.png'); ?>">
            </div>
            <div class="col-sm-3 col-md-3 col-xs-6">
               <img class="img-responsive" src="<?php echo $this->url->getStatic('images/vacation-logo2.png'); ?>">
            </div>
            <div class="col-sm-3 col-md-3 col-xs-6">
               <img class="img-responsive" src="<?php echo $this->url->getStatic('images/vacation-logo3.png'); ?>">
            </div>
            <div class="col-sm-3 col-md-3 col-xs-6">
               <img class="img-responsive" src="<?php echo $this->url->getStatic('images/vacation-logo4.png'); ?>">
            </div>
         </div>
      </div>
   </div>
